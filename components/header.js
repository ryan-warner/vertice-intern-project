export default function Header(props) {
    return (
        <div className="flex sm:flex-row gap-2 justify-start flex-col w-full sm:justify-between items-center p-4 mb-4 shadow-sm">
            ...
            <div className="flex flex-col justify-end self-start sm:self-center">
